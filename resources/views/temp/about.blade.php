...
@section('content')
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="about-content">
                        ...
                        <div class="singiture wow pixFadeUp" data-wow-delay="0.5s">
                            ...
                            <img src="{{ asset('temp/media/about/sing.png') }}" class="wow pixFadeUp" data-wow-delay="0.6s" alt="sign">
                        </div>
                        <!-- /.singiture -->
                    </div>
                    <!-- /.about-content -->
                ...
                <div class="col-lg-5">
                    <div class="about-thumb wow pixFadeRight" data-wow-delay="0.6s">
                        <img src="{{ asset('temp/media/about/1.jpg') }}" alt="about">
                    </div>
                    <!-- /.about-thumb -->
                </div>
                <!-- /.col-lg-5 -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.5s">
                        <div class="saaspik-icon-box-icon">
                            <img src="{{ asset('temp/media/feature/20.png') }}" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.6s">
                        <div class="saaspik-icon-box-icon">
                            <img src="{{ asset('temp/media/feature/19.png') }}" alt="">
                        </div>
                        <div class="pixsass-icon-box-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="saaspik-icon-box-wrapper style-four wow pixFadeLeft" data-wow-delay="0.9s">
                        <div class="saaspik-icon-box-icon">
                            <img src="{{ asset('temp/media/feature/18.png') }}" alt="">
                        </div>
                        <div class="pixsass-icon-box-content">
    ...
    <!--=         Testimonial         =-->
    <!--===============================-->
    <section class="testimonials-two-about">
        ...
        <div class="container">
            ...
            <div id="testimonial-wrapper">
                <div class="swiper-container wow pixFadeUp" data-wow-delay="0.5s" id="testimonial-two" data-speed="700" data-autoplay="5000" data-perpage="2" data-space="50" data-breakpoints='{"991": {"slidesPerView": 1}}'>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-two">
                                <div class="testi-content-inner">
                                    ...
                                    <div class="quote">
                                        <img src="{{ asset('temp/media/testimonial/quote.png') }}" alt="quote">
                                    </div>
                                    <!-- /.quote -->
                                </div>
                                <!-- /.testi-content-inner -->
        ...
        <div class="scroll-circle">
            <img src="{{ asset('temp/media/background/circle11.png') }}" data-parallax='{"y" : 250}' alt="shape">
        </div>
    </section><!-- /.testimonial -->
    ...
    <section class="teams">
        <div class="container">
            <div class="section-title text-center">
                <h3 class="sub-title wow pixFadeUp">Meet The Team</h3>
                <h2 class="title wow pixFadeUp" data-wow-delay="0.3s">Awesome pix saas Team</h2>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="team-member wow pixFadeRight" data-wow-delay="0.3s">
                        <div class="member-avater">
                            <img src="{{ asset('temp/media/team/1.jpg') }}" alt="avater">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-member wow pixFadeRight" data-wow-delay="0.5s">
                        <div class="member-avater">
                            <img src="{{ asset('temp/media/team/2.jpg') }}" alt="avater">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="team-member wow pixFadeRight" data-wow-delay="0.7s">
                        <div class="member-avater">
                            <img src="{{ asset('temp/media/team/3.jpg') }}" alt="avater">
    ...
    <section class="brand-logo-ab">
        <div class="section-small text-center">
            <h2 class="title wow pixFadeUp">Trusted Over 2500+ Companies</h2>
        </div>
        <div class="container">
            <div class="swiper-container logo-carousel wow pixFadeUp" id="logo-carousel" data-perpage="6" data-breakpoints='{"1024": {"slidesPerView": 4}, "768": {"slidesPerView": 4}, "620": {"slidesPerView": 3}}'>
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="brand-logo"><img src="{{ asset('temp/media/brand/1.png') }}" alt="brand"></div>
                    </div>
                    <!-- /.swiper-slide -->

                    <div class="swiper-slide">
                        <div class="brand-logo"><img src="{{ asset('temp/media/brand/2.png') }}" alt="brand"></div>
                    </div>
                    <!-- /.swiper-slide -->

                    <div class="swiper-slide">
                        <div class="brand-logo"><img src="{{ asset('temp/media/brand/3.png') }}" alt="brand"></div>
                    </div>
                    <!-- /.swiper-slide -->

                    <div class="swiper-slide">
                        <div class="brand-logo"><img src="{{ asset('temp/media/brand/4.png') }}" alt="brand"></div>
                    </div>
                    <!-- /.swiper-slide -->

                    <div class="swiper-slide">
                        <div class="brand-logo"><img src="{{ asset('temp/media/brand/5.png') }}" alt="brand"></div>
                    </div>
                    <!-- /.swiper-slide -->

                    <div class="swiper-slide">
                        <div class="brand-logo"><img src="{{ asset('temp/media/brand/6.png') }}" alt="brand"></div>
                    </div>
                    <!-- /.swiper-slide -->
                </div>
                <!-- /.swiper-wrapper -->
