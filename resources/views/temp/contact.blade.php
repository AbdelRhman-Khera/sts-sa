...
<!--==========================-->
				...
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="animate-element-contact">
							<img src="{{ asset('temp/media/animated/001.png') }}" alt="" class="wow pixFadeDown" data-wow-duration="1s">
							<img src="{{ asset('temp/media/animated/002.png') }}" alt="" class="wow pixFadeUp" data-wow-duration="2s">
							<img src="{{ asset('temp/media/animated/003.png') }}" alt="" class="wow pixFadeLeft" data-wow-delay="0.3s" data-wow-duration="2s">
							<img src="{{ asset('temp/media/animated/004.png') }}" alt="man" class="wow pixFadeUp" data-wow-duration="2s">
						</div>
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="contact-froms">
							<form action="#" class="contact-form" data-pixsaas="contact-froms">
								<div class="row">
									<div class="col-md-6">
		...
		<section id="google-maps">
			<div class="google-map">
				<div class="gmap3-area" data-lat="40.712776" data-lng="-74.005974" data-mrkr="{{ asset('temp/assets/img/map-marker.png') }}">
